...
public class SwaggerConfig {
    ...
    private ApiInfo getApiInfo() {
        ...
        ApiInfo apiInfo = new ApiInfo(
                "Hyperlocal ecommerce Backend : APIS ",
                "This is backend project created by Ronney",
                "1.0.0V",
                "",
                new Contact("Ronney", "https://ronneyportfolio.vercel.app/", "ronneyismael@gmail.com"),
                "License of APIS",
                "https://ronneyportfolio.vercel.app/",
                new ArrayDeque<>()
        );
