...
import com.example.hyperlocalecommerce.hyperlocalecommerce.services.UserService;
...
//        /users +POST+ user data as json
    ...
    public void updateUserTest() throws Exception {
        ...
        this.mockMvc.perform(
                        MockMvcRequestBuilders.put("/users/" + userId)
                                .header(HttpHeaders.AUTHORIZATION, "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJpc21hZWxAZ21haWwuY29tIiwiaWF0IjoxNjg2ODM4ODE0LCJleHAiOjE2ODY4NTY4MTR9.kPprRtgvdNekG_TFyr4hNEJ1Y083hztxCmquRvBggIUfXvKQRKDT2qmpm4acAe7A_hjT_GryjWslXJX8yBC26A")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(convertObjectToJsonString(user))
                                .accept(MediaType.APPLICATION_JSON)
                )
    ...
    public void getAllUsersTest() throws Exception {
        ...
        UserDto object1 = UserDto.builder().name("suraj").email("suraj@gmail.com").password("12345").about("Testing").build();
        UserDto object2 = UserDto.builder().name("biplab").email("biplab@gmail.com").password("12345").about("Testing").build();
        UserDto object3 = UserDto.builder().name("Ronney").email("ronney@gmail.com").password("12345").about("Testing").build();
        UserDto object4 = UserDto.builder().name("sivram").email("sivram@gmail.com").password("12345").about("Testing").build();
